...
| **Quiz Master** *(CanQuiz)* | Trivia across 9 categories | Math, History, Geography, Physics, Astronomy, Medicine, Sports, Celebrities, Culture — 20 questions each | **Signing Stars** | A personal karoake website load your fav songs and their lyrics and begin the fun |Firebase auth, local Storage , recoding , add tp fav list
|
